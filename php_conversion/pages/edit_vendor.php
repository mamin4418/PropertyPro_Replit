...
// Initialize variables with vendor data
$name = $vendor->name;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($vendor->update()) {
            // Redirect to vendor view
            header("Location: view_vendor.php?id={$vendor->id}");
            exit;
        } else {
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']) . '?id=' . $vendor->id; ?>" method="post">
                            <div class="card-body">
                                <?php if (!empty($errors)) : ?>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="view_vendor.php?id=<?= $vendor->id ?>" class="btn btn-default">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
